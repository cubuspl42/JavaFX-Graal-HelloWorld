...
final class MacApplication extends Application implements InvokeLaterDispatcher.InvokeLaterSubmitter {
    ...
    public static Pixels createPixels(int width, int height, int[] data, float scale) { // PATCH
        return Application.createPixels(width, height, data, scale);
    }
    
    public static float getScaleFactor(final int x, final int y, final int w, final int h) { // PATCH
        return Application.getScaleFactor(x, y, w, h);
    }

    public static Object enterNestedEventLoop() { // PATCH
        return Application.enterNestedEventLoop();
    }

    public static void leaveNestedEventLoop(Object retValue) { // PATCH
        Application.leaveNestedEventLoop(retValue);
    }

    public static void reportException(Throwable t) { // PATCH
