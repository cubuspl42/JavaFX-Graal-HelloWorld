...
public abstract class Application {
     ...
     */
    public static Object enterNestedEventLoop() { // PATCH (-> public)
        checkEventThread();
     ...
     *                               event loop
     */
    public static void leaveNestedEventLoop(Object retValue) { // PATCH (-> public)
        checkEventThread();
    ...
    public static Pixels createPixels(int width, int height, int[] data, float scale) { // PATCH (-> public)
        return Application.GetApplication().createPixels(width, height, IntBuffer.wrap(data), scale);
    }

    /* utility method called from native code */
    public static float getScaleFactor(final int x, final int y, final int w, final int h) { // PATCH (-> public)
        float scale = 0.0f;
